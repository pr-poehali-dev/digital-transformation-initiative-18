    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/0 backdrop-blur-sm">
      <div className="flex items-center justify-between px-6 py-4 text-transparent">
        <div className="flex items-center gap-3">
          <span className="text-white font-bold text-lg tracking-widest" style={{ fontFamily: "var(--font-montserrat)" }}>
            Fun Language School
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a href="#contact">
            ...
            >
              Записаться <Icon name="ArrowUpRight" size={16} className="ml-1" />
            </Button>
          </a>
        </div>
      </div>
